  ...
  chapters.push(
    {
      ...
      visual: '<figure class="chapter-visual reveal" data-asset-id="chapter-01"><div class="chapter-visual-frame"><img src="https://media.edumind.id/ebook-edumind/053-supervisi-yang-berdampak/chapter-01.webp?v=20260821-2" alt="Guru dan supervisor menelaah bukti pembelajaran secara kolegial dengan aktivitas murid terlihat di kelas" loading="lazy" decoding="async"></div><figcaption>Supervisi menjadi pembelajaran profesional ketika bukti kelas dibaca bersama, umpan balik diarahkan pada tindakan, dan tindak lanjut dinilai dari perubahan yang dialami murid.</figcaption></figure>',
      sections: [
